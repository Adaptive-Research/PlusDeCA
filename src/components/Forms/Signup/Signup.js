...
export function Signup() {
    ...
    const toLog = () => {
        navigate('/Quizreo_frontend/build/');
    }
            ...
            <div className="row">
                <Form className="mx-auto col-md-4 shadow"
                    ...
                    <Button className="mt-3 mb-3" variant="secondary" size="lg" onClick={() => {
                        navigate('/Quizreo_frontend/build/dashboard')
                    }}>
                        Signup
                    </Button>
                    <Link className="d-block mt-3 mb-3 text-decoration-none" to="/Quizreo_frontend/build/login">Login here</Link>
                </Form>
            </div>
        </div>
    )
